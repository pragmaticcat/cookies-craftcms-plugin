...
Cookie consent manager for Craft CMS 5. Provides a configurable consent popup, cookie scanner, category-based consent management, and a public cookie table for policy pages.
